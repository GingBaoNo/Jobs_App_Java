...
public class EditProfileActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        // Career Goal
        etCareerGoal = findViewById(R.id.et_career_goal);
        
        // Desired Position
        etDesiredPosition = findViewById(R.id.et_desired_position);
        etDesiredSalary = findViewById(R.id.et_desired_salary);
        spnDesiredSalaryType = findViewById(R.id.spn_desired_salary_type);
        spnWorkType = findViewById(R.id.spn_work_type);
        spnWorkTime = findViewById(R.id.spn_work_time);
        spnWorkScheduleType = findViewById(R.id.spn_work_schedule_type);
        
        // Work Experience
        etWorkExperience = findViewById(R.id.et_work_experience);
        sbTotalExperience = findViewById(R.id.sb_total_experience);
        tvTotalExperienceValue = findViewById(R.id.tv_total_experience_value);
    ...
    private void setupSpinners() {
        ...
        android.widget.ArrayAdapter<String> educationAdapter = new android.widget.ArrayAdapter<>(this,
        ...
        android.widget.ArrayAdapter<String> salaryTypeAdapter = new android.widget.ArrayAdapter<>(this,
        ...
        android.widget.ArrayAdapter<String> workTypeAdapter = new android.widget.ArrayAdapter<>(this,
        ...
        android.widget.ArrayAdapter<String> workTimeAdapter = new android.widget.ArrayAdapter<>(this,
        ...
        android.widget.ArrayAdapter<String> workScheduleTypeAdapter = new android.widget.ArrayAdapter<>(this,
                    ...
                    if (apiResponse.isSuccess() && apiResponse.getData() != null) {
                        if (apiResponse.getData() instanceof java.util.Map) {
                            ...
                            if (currentProfile != null) {
                                ...
                                Toast.makeText(EditProfileActivity.this, "Dữ liệu hồ sơ không hợp lệ", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(EditProfileActivity.this, "Dữ liệu không đúng định dạng", Toast.LENGTH_SHORT).show();
                        }
                    } else {
