...
public class AppliedJobsActivity extends AppCompatActivity {
    ...
    private void initViews() {
        rvAppliedJobs = findViewById(R.id.rv_applied_jobs);
        appliedJobsList = new ArrayList<>();
        adapter = new AppliedJobsAdapter(this, appliedJobsList);
            ...
            public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (apiResponse.isSuccess() && apiResponse.getData() != null) {
                        ...
                        Toast.makeText(AppliedJobsActivity.this, apiResponse.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(AppliedJobsActivity.this, "Không thể tải danh sách công việc đã ứng tuyển", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<ApiResponse> call, Throwable t) {
                Toast.makeText(AppliedJobsActivity.this, "Lỗi kết nối: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
