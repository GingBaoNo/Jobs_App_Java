...
public class FeaturedCompanyAdapter extends RecyclerView.Adapter<FeaturedCompanyAdapter.FeaturedCompanyViewHolder> {
    private List<Company> companyList;
    private Context context;

    public FeaturedCompanyAdapter(List<Company> companyList, Context context) {
    ...
    @NonNull
    @Override
    public FeaturedCompanyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_featured_company, parent, false);
        return new FeaturedCompanyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FeaturedCompanyViewHolder holder, int position) {
    ...
    public class FeaturedCompanyViewHolder extends RecyclerView.ViewHolder {
        ...
        public FeaturedCompanyViewHolder(@NonNull View itemView) {
            super(itemView);
