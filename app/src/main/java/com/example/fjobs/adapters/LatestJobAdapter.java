...
public class LatestJobAdapter extends RecyclerView.Adapter<LatestJobAdapter.JobViewHolder> {
    private List<JobDetail> jobList;
    private Context context;

    public LatestJobAdapter(List<JobDetail> jobList, Context context) {
